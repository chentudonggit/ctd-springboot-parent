...
import com.ctd.springboot.feign.exception.configuration.mvc.WebMvcFeignConfiguration;
...
@ImportAutoConfiguration(classes = {WebMvcRequestMappingHandlerMappingConfiguration.class, WebMvcFeignConfiguration.class,
